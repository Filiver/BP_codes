...
class TestODO:
    ...
    def test_matching_pennies(self, epsilon):
        ...
        result = online_double_oracle(matching_pennies, epsilon=epsilon)
    ...
    def test_rocks_paper_scissors(self, epsilon):
        ...
        result = online_double_oracle(rocks_paper_scissors, epsilon=epsilon)
    ...
    def test_penalty_kicks(self, epsilon):
        ...
        result = online_double_oracle(penalty_kicks, epsilon=epsilon)
    ...
    def test_morra(self, epsilon):
        ...
        result = online_double_oracle(morra, epsilon=epsilon)
    ...
    def test_random_game_1(self, epsilon):
        ...
        result = online_double_oracle(game, epsilon=epsilon)
